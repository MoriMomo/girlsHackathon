...
export default function Tracker({ wallet }) {
  ...
  async function handleAdd(e) {
    ...
    setBusy(true)
    try {
      showToast('info', 'Confirm the transaction in MetaMaskâ€¦')
    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Each entry is written to {TARGET.chainName} â€” permanent, public, and impossible to edit or
          delete.
        </p>
      </div>
      ...
      <form onSubmit={handleAdd} className="mb-8 rounded-xl border border-slate-200 bg-white p-5">
        <div className="mb-4 flex flex-wrap items-center gap-3">
          ...
          >
            {scanning ? 'Scanningâ€¦' : 'Scan receipt'}
          </button>
          <span
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-5">
          ...
          <div className="sm:col-span-2">
            ...
            <input
              ...
              placeholder="Lunch, bus fare, groceriesâ€¦"
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500"
            />
          </div>
          <div className="sm:col-span-1">
